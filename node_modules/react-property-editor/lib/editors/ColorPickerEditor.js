    ...
    _createClass(ColorPickerEditor, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                'div',
                null,
                _react2['default'].createElement(_reactColorsPicker2['default'], { animation: 'slide-up', color: value.color || DEFAULT_COLOR, alpha: value.alpha, onChange: this.props.onUpdated })
            );
        }
    }]);
