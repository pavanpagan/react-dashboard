...
var BoxSizeEditor = (function (_React$Component) {
    _inherits(BoxSizeEditor, _React$Component);

    function BoxSizeEditor(props) {
        _classCallCheck(this, BoxSizeEditor);

        _get(Object.getPrototypeOf(BoxSizeEditor.prototype), 'constructor', this).call(this, props);
        this.state = { show: false };
    }

    _createClass(BoxSizeEditor, [{
        key: 'toogle',
    ...
    return BoxSizeEditor;
})(_react2['default'].Component);

exports['default'] = BoxSizeEditor;
