...
var PlainJsonEditor = (function (_React$Component) {
    _inherits(PlainJsonEditor, _React$Component);

    //static propTypes = {onClose: PropTypes.func}

    function PlainJsonEditor(props) {
        _classCallCheck(this, PlainJsonEditor);

        _get(Object.getPrototypeOf(PlainJsonEditor.prototype), 'constructor', this).call(this, props);
        this.state = { show: false, value: JSON.stringify(this.props.value, null, 2) };
    }

    _createClass(PlainJsonEditor, [{
        key: 'close',
    ...
    return PlainJsonEditor;
})(_react2['default'].Component);

exports['default'] = PlainJsonEditor;
;
